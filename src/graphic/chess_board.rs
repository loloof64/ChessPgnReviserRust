...
impl ChessBoardPainter {
    fn draw_background(context: &cairo::Context, background_color: (f64, f64, f64)) {
...
impl Widget for ChessBoard {
    ...
    fn init_view(&mut self) {
        ...
        self.canvas.connect_draw(move |_source, context| {
            ChessBoardPainter::draw_background(context, background_color);
            ChessBoardPainter::draw_cells(context, white_cells_color, black_cells_color, size);
